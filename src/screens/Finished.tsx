  ...
  return (
    <div className="">
      <div className="bg-sky-400 border-2 border-zinc-900 rounded-lg min-h-[300px] min-w-[300px] relative flex flex-col justify-center items-center mb-20">
        ...
        <div className="w-[100px] h-[100px] rounded-full border border-orange-50 bg-violet-900 py-4 px-4 text-orange-50 flex justify-center items-center mb-4">
      ...
      <div>
        <button
          className="w-full mb-4 uppercase inline-block rounded-full  bg-violet-900 border-2 border-orange-50 font-semibold text-orange-50 tracking-wide px-4 py-2.5 animate-pulse"
